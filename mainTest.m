...
tspan = [0 60];              % intervallo di simulazione
...
if flagPlot == 1
    ...
    if voloVerticale == 1
        ...
        subplot(3,1,1);
        h5 = plot(time, phi, 'r','LineWidth',2);
        legend('Phi (Roll)','FontSize',14,'Location','best')
        grid on
        ylabel('gradi','FontSize',14)
        set(gca,'FontSize',14)
        title('Phi (Roll)','FontSize',16)

        subplot(3,1,2);
        h6 = plot(time, theta, 'b','LineWidth',2);
        legend('Theta (Pitch)','FontSize',14,'Location','best')
        grid on
        ylabel('gradi','FontSize',14)
        set(gca,'FontSize',14)
        title('Theta (Pitch)','FontSize',16)

        subplot(3,1,3);
        h7 = plot(time, psi, 'g','LineWidth',2);
        legend('Psi (Yaw)','FontSize',14,'Location','best')
        grid on
        ylabel('gradi','FontSize',14)
        set(gca,'FontSize',14)
        title('Psi (Yaw)','FontSize',16)
